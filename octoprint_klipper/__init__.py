...
# API for Backups
    ...
    def get_backup(self, filename):
        ...
        return flask.jsonify(cfgUtils.get_cfg(self, full_path))
    ...
    def delete_backup(self, filename):
        ...
        if (
            ...
            try:
                ...
                return flask.jsonify(status='error', data=dict(message='Could not delete {}'.format(filename)))
    ...
    def list_backups(self):
        return flask.jsonify(cfgUtils.list_config_files(self, "backup"))
    ...
    def restore_backup(self, filename):
        ...
        return flask.jsonify(copy_file(self, backupfile, config_path))
...
# API for Configs
    ...
    def delete_config(self, filename):
        ...
        if (
            ...
            try:
                ...
                self._octoklipper_logger.exception("Could not delete {}".format(filename))
                return flask.jsonify(status='error', error=dict(message='Could not delete {}'.format(filename)))
        return flask.jsonify(status = 'success')
    ...
    def list_configs(self):
        files = cfgUtils.list_config_files(self, "")
        path = os.path.expanduser(
            self._settings.get(["configuration", "config_path"])
        )
        return flask.jsonify(status = 'success', data = dict(files = files, path = path, max_upload_size = MAX_UPLOAD_SIZE))
    ...
    def check_config(self):
        ...
        return flask.jsonify(cfgUtils.check_config(self, data_to_check))
    ...
    def save_config(self):
        ...
        results = cfgUtils.save_cfg(self, Filecontent, filename)
    ...
    def modify_service_file(self):
        ...
        return flask.jsonify(modify_servicefile(self, file_path, replace_path, config_path))
